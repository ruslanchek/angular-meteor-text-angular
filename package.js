...
Package.onUse(function(api) {
	...
	api.addFiles('src/textAngularSetup.js', where); // Files in use
	api.addFiles('src/textAngular.js', where); // Files in use
	api.addFiles('src/textAngular-sanitize.js', where); // Files in use
});
